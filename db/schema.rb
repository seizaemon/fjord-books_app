...
ActiveRecord::Schema.define(version: 2023_02_04_051500) do
  ...
  create_table "follow_relations", force: :cascade do |t|
    ...
    t.index ["follower_id", "followee_id"], name: "index_follow_relations_on_follower_id_and_followee_id", unique: true
